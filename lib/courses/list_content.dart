...
class ListContent extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        ContentCardSmall('assets/img/listasCont/LC_01.png', 'Nudos quirúrgicos', '65', 'assets/img/listasCont/carga_01.png', onPressed: (){ Navigator.push(context, new MaterialPageRoute(
